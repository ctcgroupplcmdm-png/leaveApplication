...
function PersonalInfo() {
 ...
 const fetchUserInfo = (oid) => {
   ...
   fetch(urlUserInfo, {
     ...
     .then((data) => {
       ...
       // If API sent a single "name" number, split it into number
 ...
 const handleChange = (e) => {
   ...
   // When choosing a street, auto-fill Area + City
...
<Typography variant="h6" fontWeight="bold" sx={{ mb: 2 }}>
         ...
         {/* Row 1: Postal Code, Street, Street No, Area (disabled), City (disabled) */}
<Grid container spacing={3}>
...
<TextField
         ...
         {/* Row 2: Apartment only (kept simple as requested) */}
